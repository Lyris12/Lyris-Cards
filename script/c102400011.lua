...
function s.initial_effect(c)
	--"Inlightened Psychic Helmet" Must first be Evolve Summoned while all monsters you control (min. 2) are LIGHT. If this card is Evolve Summoned: You can add 1 "Inlightened Ultima" monster from your Deck to your hand. Cannot attack. You can reveal 1 "Inlightened Ultima" monster in your hand; Special Summon 1 monster from your Deck or GY whose name is specifically listed on that monster. You can only use this effect of "Inlightened Eagle Eyeglass" once per turn.
	c:EnableReviveLimit()
