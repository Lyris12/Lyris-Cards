...
function s.initial_effect(c)
	--U-If a "Blitzkrieg" Monster Card(s) is destroyed: You can target 1 monster your opponent controls; destroy that target, then inflict damage to your opponent equal to half the destroyed monster's DEF on the field. You can only use 1 "Blitzkrieg Element - Flame" effect per turn, and only once that turn.
	--M-If your opponent declares an attack that targets this card: Negate the attack, also destroy this card, then destroy 1 Spell/Trap your opponent controls. If this card is destroyed: You can target 1 monster your opponent controls; destroy that target, then inflict damage to your opponent equal to half the destroyed monster's ATK on the field. You can only use 1 "Blitzkrieg Element - Flame" effect per turn, and only once that turn.
