...
function s.initial_effect(c)
	--If you control no monsters in your Main Monster Zones: You can Special Summon 1 "YC.Org" monster from your hand. You can target 1 other "YC.Org" card you control; Destroy it, and if you do, add 1 "YC.Org" Spell/Trap card from your Deck to your hand. If a "YC.Org" Link Monster you control would be destroyed by your opponent's card effect, you can destroy this card instead. You can only use each effect of "YC.Org Headquarters" once per turn.
