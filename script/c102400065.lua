...
function s.initial_effect(c)
	--If this card attacks a Defense Position monster, inflict piercing battle damage. Gains 100 ATK for each other "Swordsmaster" monster you control. During the Main Phase, if a monster changed its battle position this turn (Quick Effect): You can Special Summon this card from your hand in face-up Attack Position. You can only use this effect of "Raymond the Swordsmaster" once per turn. If this card is Special Summoned, immediately choose 1 of your opponent's Attack Position monsters, and change it to face-up Defense Position, OR if you cannot, negate its effects, also, halve its ATK.
