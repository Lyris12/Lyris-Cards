...
function s.initial_effect(c)
	--1+ "Voidictator" monsters + 1 DARK Fiend monsters / You can only control 1 "Voidictator Demon - Unformed Malevolence". Up to thrice per turn, if your opponent Special Summons a Spatial Monster: This card gains that monster's effects until the end of the next turn. Can attack all monsters your opponent controls, once each. If this card leaves the field because of an opponent's card, OR if this card is banished by a "Voidictator" card you own: Return this card to the Extra Deck, then, you can banish all cards on the field. Cards banished by this effect do not activate their effects. You can only use this effect of "Voidictator Demon - Unformed Malevolence" once per turn.
	c:EnableReviveLimit()
