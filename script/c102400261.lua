...
function s.initial_effect(c)
	--Add 1 "Armarine" monster from your Deck to your hand, then you can destroy 1 "Armarine" monster in your hand with a different name. You can only activate 1 "Armarine Calling" per turn. You can banish this card from your GY; Immediately after this effect resolves, Normal Summon 1 "Armarine" monster from your hand.
