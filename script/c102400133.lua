...
function s.initial_effect(c)
	--Halve all damage you take while only your opponent controls a monster. During your Main Phase: You can destroy 1 "Blitzkrieg" monster in your hand, and if you do, add 1 "Blitzkrieg" monster from your Deck to your hand. You can only use this effect of "Blitzkrieg Sky" once per turn. Once per turn, if a "Blitzkrieg" monster(s) would be destroyed, except as material, you can destroy 1 face-up "Blitzkrieg" Pendulum monster in your Extra Deck instead.
