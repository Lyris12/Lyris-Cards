...
function s.initial_effect(c)
	--2 "Icybr" monsters with different names Once per turn: You can reveal 1 "Icybr" card in your hand, and it will remain revealed until the end of the next turn; Special Summon 1 "Icybr" monster from your GY with a different name than the monsters you control and revealed in your hand, but you can only Special Summon a monster(s) of each Type up to twice for the rest of this turn.
	c:EnableReviveLimit()
