...
function s.initial_effect(c)
	--If you control no monsters in your Main Monster Zone, you can Special Summon this card (from your hand). You can only Special Summon "Moon's Dream of YC.Org" once per turn this way. You can discard 1 card; Return this card to your hand, and if you do, send 1 "YC.Org" or "Moon's Dream" card from your Deck to the GY. If this card is sent to the GY by the effect of a "Moon's Dream" or "YC.Org" card: You can excavate the top 3 cards of your Deck, add 1 excavated "Moon's Dream" or "YC.Org" card from among them to your hand, also shuffle the rest into the Deck. You can only use each effect of "Moon's Dream of YC.Org" once per turn.
