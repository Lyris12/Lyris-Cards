--created by Discord \ Ace/Verloren
--業が深いシェルヴァレット・ドラゴン
local s,id,o=GetID()
function s.initial_effect(c)
	--U-You can Special Summon Pendulum Monsters from your Extra Deck to unlinked Main Monster Zones. You can only use each of the following Pendulum Effects of "Sinful Shelrokket Dragon" once per turn. If this card is placed in the Pendulum Zone by its own effect: Special Summon 1 Level 1 "Rokket" monster from your Deck. If a "Rokket" monster(s) you control is destroyed: Special Summon 1 "Rokket" monster with a lower Level than 1 of those destroyed monsters from your Deck.
	--M-If a Link Monster's effect is activated that targets this face-up card on the field: You can destroy this card, and if you do, send 1 Fusion, Synchro, Xyz, or Link Monster on the field to the GY. If this face-up card on the field is destroyed by your card effect: You can place it in your Pendulum Zone.
