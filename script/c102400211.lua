...
function s.initial_effect(c)
	--1+ monsters with a Level, including a "Roman Keys" monster Must first be Fusion Summoned with a "Roman Keys" card effect. When this card is Summoned: You can destroy 1 monster on the field. (Quick Effect): You can Tribute this card; Special Summon 1 "Roman Keys" monster from your hand or Deck, but you cannot Summon from the Deck with this effect of "Roman Keys - XV" for the rest of this turn.
	c:EnableReviveLimit()
