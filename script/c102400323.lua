...
function s.initial_effect(c)
	--Cannot be Special Summoned. FLIP: Destroy all cards the turn player's opponent controls, then for each card destroyed by this effect, they add the bottom card of their GY to their hand, also the turn player skips their next Battle Phase this turn. (End the Battle Phase instead, if this effect was activated during the Battle Phase.)
