...
function s.initial_effect(c)
	--2 monsters If this card was Link Summoned without using a "Cyber Dragon" monster as material, it cannot attack or be used as Link Material and its other effects cannot be applied/resolved. Gains 1000 ATK. This card's name becomes "Cyber Dragon" while on the field or in the GY. If this card is Link Summoned: You can activate 1 of these effects. ● Add any number of "Cyber Dragon" from your GY to your hand, then place the same number of cards from your hand on the bottom of your Deck. ● Banish 1 Normal or Quick-Play Spell from your Deck that mentions a "Cyber Dragon" monster and/or has "Machine" in its text, and if you do, this effect becomes that Spell's effect that Fusion Summons a Fusion Monster from your Extra Deck when that card is activated.
	c:EnableReviveLimit()
