...
function s.initial_effect(c)
	--If all your monsters are "Entrafor" monsters (min. 1): You can Special Summon this card from your hand. If this card destroys a card by battle or inflicts battle damage to your opponent: You can attach this card to 1 of your Xyz Monsters, then Special Summon 1 "Entrafor" monster attached to an Xyz Monster you control, except "Mirror Entraformer".
