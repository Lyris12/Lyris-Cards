...
function s.initial_effect(c)
	--(Quick Effect): You can banish this card from your hand or field; Fusion Summon any number of "Roman Keys" Fusion monsters from your Extra Deck, using "Roman Keys" monsters from your hand or field as the Fusion materials, but you cannot Summon monsters whose total Levels exceed the total Levels of the materials this way. You cannot Special Summon monsters from the Extra Deck the turn you use this effect, except "Roman Keys" monsters. You can only use this effect of "Roman Keys - XXX" once per turn.
