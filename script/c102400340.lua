...
function s.initial_effect(c)
	--During your turn (Quick Effect): You can reveal this card in your hand, and it will remain revealed until the end of the next turn; you can only Special Summon a monster(s) of each Type up to twice for the rest of this turn, also Special Summon 1 "Icybr" monster from your hand or GY, except "Icybr Ecclesa", then you can destroy 1 card your opponent controls, plus up to 1 more if you Summoned from the hand. You can only use this effect of "Icybr Ecclesa" once per turn.
