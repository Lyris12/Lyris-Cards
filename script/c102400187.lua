...
function s.initial_effect(c)
	--2 Warrior monsters The total Levels of this card's Fusion Materials must equal 5 or more. If a monster with higher ATK than this Fusion Summoned card is on the field (Quick Effect): You can destroy the 1 face-up monster on the field that has the highest ATK (your choice, if tied). This effect can only be used once while this card is face-up on the field.
	c:EnableReviveLimit()
