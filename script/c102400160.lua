...
function s.initial_effect(c)
	--At the start of the Duel, flip this card over. Each time your opponent activates a card or effect, shuffle 1 "Blitzkrieg" monster into the Deck, from your GY or face-up from your Extra Deck, then up to 3 times per Duel, you can apply this effect immediately after that effect resolves. ● Destroy 1 "Blitzkrieg" Monster Card you control and 1 card your opponent controls.
