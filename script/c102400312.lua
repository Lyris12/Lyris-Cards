...
function s.initial_effect(c)
	--1 Tuner + 1+ non-Tuner monsters Once per turn: You can increase or reduce this card's Level by up to 4. If you use this card for a Synchro Summon, you can treat it as a non-Tuner. Once per Chain, during the Main Phase, you can (Quick Effect): Immediately after this effect resolves, Synchro Summon using this card you control.
	c:EnableReviveLimit()
