...
function s.initial_effect(c)
	--Neither player takes any battle damage from attacks involving this card. You can only use each of the following effects of "Phantasm of Chaos" once per turn. ● You can banish 2 DARK monsters from your GY; Special Summon this card from your hand. ● During the Main Phase (Quick Effect): You can banish 1 monster from either GY; this card gains ATK equal to that monster's ATK, also until the end of the next turn, this card gains that monster's effects.
