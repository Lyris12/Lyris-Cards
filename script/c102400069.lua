...
function s.initial_effect(c)
	--2+ Level 4 "Swordsmaster" monsters / If this card attacks a Defense Position monster, inflict piercing battle damage. Gains 200 ATK and DEF for each material attached to this card. Once per turn, during the Main Phase (Quick Effect): You can detach 1 material from this card, then target 1 monster your opponent controls; Special Summon 1 "Swordsmaster" monster from your hand or GY in face-up Attack Position, then change that target to face-down Defense Position. If this Xyz Summoned card is destroyed: You can target 2 "Swordsmaster" monsters in your GY; Special Summon them, then immediately after this effect resolves, Xyz Summon 1 "Swordsmaster" Xyz Monster, except "Alexiand the Swordsmaster", using only those 2 monsters.
	c:EnableReviveLimit()
