...
function s.initial_effect(c)
	--1 "YC.Org" Tuner + 1+ non-Tuner monsters When this card is Synchro Summoned: You can banish 1 "YC.Org" monster from your Deck or GY; Special Summon 1 "YC.Org" monster with a different name from your hand or that is banished, also for the rest of this turn you cannot Special Summon monster, except "YC.Org" monsters. If this card is linked to a "YC.Org" monster: You can banish 1 "YC.Org" card from your hand and 1 "YC.Org" card from your GY; your opponent discards 1 card. You can only use each effect of "Glitchy, Angelic Guardian of YC.Org" once per turn.
	c:EnableReviveLimit()
