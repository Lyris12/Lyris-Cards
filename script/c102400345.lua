...
function s.initial_effect(c)
	--If you control no monsters: You can also reveal 1 "Icybr" card in your hand, and it will remain revealed until the end of the next turn; you can only Special Summon monster(s) of each Type up to twice for the rest of this turn, also add 1 "Icybr" monster from your Deck to your hand, then, if you revealed a card to activate this card, you can Special Summon 1 "Icybr" monster from your hand. You can only activate 1 "Icybreeze" per turn.
