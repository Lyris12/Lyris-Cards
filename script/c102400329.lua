...
function s.initial_effect(c)
	--You can Special Summon this card (from your hand) to your opponent's field in Attack Position by Tributing 1 monster they control, then shift control to this card's owner during the End Phase. If Summoned this way: Your opponent targets 1 other monster you control; give control of it to your opponent, also your opponent's current face-up cards are unaffected by your Spell effects until the end of the next turn. You can only use this effect of "Rigil Dinhorus" once per turn.
