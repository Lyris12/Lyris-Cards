...
function s.initial_effect(c)
	--U-Each time a Monster Card(s) is destroyed, increase this card's Energy by 1 for each destroyed card. ▼ [-1]: (Quick Effect): Target 1 "Blitzkreig" monster in your GY or that is banished, except "The Blitzkrieg Meknight"; either place it in your Pendulum Zone or Special Summon it.
	--M-If your opponent declares an attack that targets this card, destroy this card. After this card is Special Summoned, your other "Blitzkrieg" monsters gain 300 ATK, also they are unaffected by your opponent's card effects that would not destroy them.
