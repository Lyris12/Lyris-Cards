...
function s.initial_effect(c)
	--2 "Swordsmaster" monsters If this card attacks a Defense Position monster, inflict piercing battle damage. Gains 100 ATK for each "Swordsmaster" monster you control. If a "Swordsmaster" monster activates its effect: You can Special Summon 1 "Swordsmaster" monster from your GY in face-up Defense Position to your zone this card points to. You can only use this effect of "Winged Swordsmaster Iona" once per turn.
	c:EnableReviveLimit()
