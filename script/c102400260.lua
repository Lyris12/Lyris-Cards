...
function s.initial_effect(c)
	--1 Tuner + 1+ non-Tuner monsters For this card's Synchro Summon, you can treat 1 "Armarine" monster as a Tuner. Once per turn: You can destroy 1 monster in your hand, and if you do, Special Summon 1 "Armarine" monster with a different name than that monster from your Deck. Unless 3 or more attacks were declared this turn or the previous turn, you must destroy an "Armarine" monster with this effect. If this card is destroyed: Draw 1 card.
