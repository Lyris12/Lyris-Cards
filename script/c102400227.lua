...
function s.initial_effect(c)
	--2 Level 4 monsters Cannot be used as Link Material. Cannot declare an attack unless you detach 2 materials from it or Tribute 2 cards equipped to it. Once per turn, during the End Phase, equip 1 card from your hand to this card as an Equip Spell (this is not optional), or this card is sent to the GY.
	c:EnableReviveLimit()
