...
function s.initial_effect(c)
	--Cannot be Normal Summoned/Set. Must first be Special Summoned (from your hand) by shuffling 2 "Inlightened" monsters from your GY into the Deck and Tributing 1 "Inlightened Eatos Wings". This card can attack directly. If your "Inlightened" monster battles, after damage calculation: Target 1 monster in your opponent's GY or that is banished (if possible); Inflict damage to your opponent equal to half the ATK of that target (if any). You can only control 1 "Inlightened Ultima" monster.
	c:EnableReviveLimit()
