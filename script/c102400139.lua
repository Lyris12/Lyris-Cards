...
function s.initial_effect(c)
	--During the Main Phase: Target 2 "Blitzkrieg" cards in your Pendulum Zones; destroy that card(s), and if you do, Special Summon up to 1 "Blitzkrieg" monster each from your hand, GY, and face-up Extra Deck, each with a Level between (exclusive) the Pendulum Scales of those destroyed cards. You can only activate 1 "Blitzkrieg Downpour" per turn.
