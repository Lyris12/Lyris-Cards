...
function s.initial_effect(c)
	--If you control exactly 2 "Blitzkrieg" cards (and no other cards), you can activate this card from your hand. All monsters must attack, if able. Each time an attack is declared involving a "Blitzkrieg" monster, place 1 Lightning Counter on this card. If a "Blitzkrieg" monster declares an attack: Destroy the attacking monster. You can only use this effect of "Blitzkrieg Deity - Zeus" once per turn. If this face-up card with a Lightning Counter on it is destroyed: End the Main Phase.
...
function s.handcon(e)
	...
	return Duel.GetFieldGroupCount(tp,LOCATION_ONFIELD,0)==2 and Duel.IsExistingMatchingCard(s.hfilter,tp,LOCATION_ONFIELD,0,2,nil)
end
