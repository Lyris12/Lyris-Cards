...
function s.initial_effect(c)
	--3 LIGHT "uken" monsters with different names There can only be 1 "Psychic Hadouken" in the Monster Zone. Any card sent to the GY is placed on the bottom of the Deck instead, while your Deck has an even number of cards. Once per turn: You can place 1 LIGHT/Spell/Trap "uken" card from your hand or field on the bottom of the Main Deck, then target 1 card your opponent controls; banish 1 card its owner controls. You can only use this of "Psychic Hadouken" once per turn.
	c:EnableReviveLimit()
