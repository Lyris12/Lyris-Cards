...
function s.initial_effect(c)
	--This card's Level is doubled during the turn it is Summoned. During your Standby Phase, if this card is in the GY while you have no Spells/Traps in your GY: You can Special Summon this card. You can only use this effect of "Roman Keys - XLIX" once per turn.
