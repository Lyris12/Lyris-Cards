...
function s.initial_effect(c)
	--If your "Inlightened" monster attacks, your opponent's cards and effects cannot be activated until the end of the Damage Step. If your "Inlightened" monster attacks, after damage calculation: Target 1 Spell/Trap your opponent controls, also if you attacked directly, you can target an additional Spell/Trap your opponent controls; banish that target(s). You can only use this effect of "Inlightened Kay'est Tail" once per turn.
