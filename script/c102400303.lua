...
function s.initial_effect(c)
	--You can only control 1 "Chaos Beckoning". Equip only to a DARK Fiend monster. The equipped monster gains 300 ATK for each banished monster and 300 DEF for each face-down banished card. If this card leaves the field while equipped to a Level 8 or higher DARK Fiend monster: Banish as many cards on the field as possible. You can only activate 1 "Chaos Beckoning" per turn.
