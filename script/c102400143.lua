...
Card.IsLyrisForce=Card.IsLyrisForce or function(c) return c:IsCode(102400132,102400143,102400144) end
	--Target 1 Xyz Monster you control; Special Summon from your Extra Deck, 1 "Blitzkrieg" Xyz Monster with the same Type as that monster but 1 Rank higher by using that target as the material. (This Special Summon is treated as an Xyz Summon. Transfer its materials to the Summoned monster.) If a monster that was Summoned by this card's effect is destroyed and sent to the GY: You can add this card from your GY to your hand. You can only use this effect of "Rank-Up-Magic Lyris Force" once per Duel.
