...
function s.initial_effect(c)
	--You can only control 1 "Mark of Chaos". When this card is activated, shuffle as many cards from both player's GYs into the Deck as possible. While you control a Level 8 or higher DARK Fiend monster, any card sent to the GY is banished instead. While at least 5 or more DARK Fiend monsters are banished, all monsters on the field, in the GYs, and among each player's banished cards become DARK Fiend monsters. You can only activate 1 "Mark of Chaos" per turn.
