...
function s.initial_effect(c)
	--This card's Level is doubled during the turn it is Summoned. When this card is Summoned: You can shuffle up to 5 "Roman Keys" monsters from your GY into the Deck, and if you do, apply these effects (simultaneously), based on the number of cards shuffled into the Deck this way. ● 3+: Draw 1 card. ● 5: Add 1 "Roman Keys" monster from your Deck to your hand.
...
function s.target(e,tp,eg,ep,ev,re,r,rp,chk)
	if chk==0 then return #Duel.GetMatchingGroup(aux.AND(s.filter,Card.IsAbleToDeck),tp,LOCATION_GRAVE,0,nil)>0 end
