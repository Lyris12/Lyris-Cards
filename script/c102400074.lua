...
function s.initial_effect(c)
	--Apply 1 of these effects. ● Special Summon 1 "Swordsmaster" monster attached to an Xyz Monster you control. ● Attach 1 "Swordsmaster" monster from your hand or GY to your Xyz Monster as material. You can only activate 1 "Oath of the Swordsmasters" per turn.
