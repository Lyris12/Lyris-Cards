...
function s.initial_effect(c)
	--Target 1 "Rigil" monster in your GY; add it to your hand. You can banish this card from your GY; Special Summon from your GY as many "Rigil" monsters as possible to your opponent's field in Attack Position. (This is treated as each monster being Special Summoned using their own procedure.) You can only use this effect of "Rigil Ribirth" once per turn.
