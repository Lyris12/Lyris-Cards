...
Card.IsLyrisForce=Card.IsLyrisForce or function(c) return c:IsCode(102400132,102400143,102400144) end
	--If a "Blitzkrieg" Xyz Monster was destroyed and sent to the GY this turn while you controlled it: Target 1 "Blitzkrieg" Xyz Monster in your GY; Special Summon it, then Special Summon from your Extra Deck, 1 LIGHT Dragon or Machine Xyz Monster that is 1 or 2 Ranks higher than that monster, by using it as the Xyz Material. (This is treated as an Xyz Summon.)
