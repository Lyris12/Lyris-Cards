...
function s.initial_effect(c)
	--When your opponent activates a card or effect in response to a "Rigil" monster effect: Negate the activation, and if you do, take control of that "Rigil" monster until the End Phase (if possible).
