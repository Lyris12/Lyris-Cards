...
function s.initial_effect(c)
	--Target 1 "Blitzkrieg" monster you control and 1 "Blitzkrieg" monster in your GY with a different name from that target; destroy that first target, then Special Summon that other target. You can only activate 1 "Blitzkrieg Samsara Bolt" per turn.
