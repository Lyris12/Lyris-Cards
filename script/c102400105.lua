...
function s.initial_effect(c)
	--U-If a "Blitzkrieg" Monster Card(s) is destroyed: You can target 1 other card you control and 1 card your opponent controls; return them to the hand. You can only use 1 "Blitzkrieg Meknight - O'Dark" effect per turn, and only once that turn.
	--M-If your opponent declares an attack that targets this card: Negate the attack, also destroy this card, then destroy 1 Spell/Trap your opponent controls. If this card is destroyed: You can target 1 other card you control and 1 card your opponent controls; return them to the hand. You can only use 1 "Blitzkrieg Meknight - O'Dark" effect per turn, and only once that turn.
