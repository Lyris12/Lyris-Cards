...
function s.initial_effect(c)
	--You can Special Summon this card (from your hand) to your opponent's field in Attack Position by banishing 2 random cards from their hand face-down until the End Phase, then shift control to this card's owner during the End Phase. If this card is Normal or Special Summoned: Its owner's current monsters gain 500 ATK/DEF for each "Rigil" monster their opponent controls, also until the end of the next turn, if this card was Summoned using its own procedure, send the first monster that attacks during your turn to the GY. You can only use this effect of "Rigil Zentaurus" once per turn.
