...
function s.initial_effect(c)
	--If you control no monsters: You can Special Summon this card from your hand. During your Main Phase: You can attach this card to your "Entraforemost" Xyz Monster as material, then you can Special Summon 2 "Entraformer" monsters with different names from your hand or Deck, but they have their effects negated. You can only use each effect of "Entraformer Ringmaster" once per turn.
