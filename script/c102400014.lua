...
function s.initial_effect(c)
	--You can discard this card; Special Summon 1 "Inlightened Psychic Helmet" from your hand or GY. Your opponent cannot target your other "Inlightened" monsters with card effects. If your "Inlightened" monster attacks, after damage calculation: Target 1 face-up monster you control; send 1 "Inlightened" monster from your hand or Deck to the GY, and if you do, that target's name becomes the sent monster's name while on the field. This change lasts until the end of the turn unless you attacked directly.
