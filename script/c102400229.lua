...
function s.initial_effect(c)
	--You can Special Summon this card (from your hand) by banishing 1 "YC.Org" or "Voidictator" monster from your hand. You can only Special Summon 1 "Walrus, Voidictator of YC.Org" per turn this way. If this card is banished: You can target 1 "Voidictator" or "YC.Org" monster you control; Banish it, and if you do, Special Summon this card, then draw 1 card. You cannot Special Summon monsters the turn you activate this effect, except "Voidictator and/or "YC.Org" monsters. You can only use this effect of "Walrus, Voidictator of YC.Org" once per turn.
