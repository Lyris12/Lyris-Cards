...
function s.initial_effect(c)
	--Cannot attack. Once per your Standby Phase, if this card is in your GY: You can Special Summon it in Attack Position, then Special Summon 1 "Inlightened" monster from your hand or GY. You cannot Special Summon monsters the turn you use this effect, except "Inlightened" monsters. Cannot be targeted for attacks, while you control another "Inlightened" monster. You can only control 1 "Inlightened Psychic Helmet".
