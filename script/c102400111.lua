...
function s.initial_effect(c)
	--U-If a "Blitzkrieg" Monster Card(s) is destroyed: You can target 1 WATER "Blitzkrieg" monster in your GY; Special Summon it. You can only use 1 "Blitzkrieg Dragon - Moon" effect per turn, and only once that turn.
	--M-If your opponent declares an attack that targets this card: Negate the attack, also destroy this card, then destroy 1 monster your opponent controls. If this card is destroyed: You can target 1 FIRE "Blitzkrieg" monster in your GY; Special Summon it. You can only use 1 "Blitzkrieg Dragon - Moon" effect per turn, and only once that turn.
