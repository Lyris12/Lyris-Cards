...
function s.initial_effect(c)
	--Once per turn, during the Damage Step, if your other monster battles while this card is in your hand or field (Quick Effect): You can Special Summon 1 "Armarine" monster from your Deck with a different name from the monster you control and/or in your GY, then destroy this card. If this card is destroyed by a card effect: Return 3 other "Armarine" monsters from your GY to the Deck, then draw 1 card.
...
function s.filter(c)
	return c:IsSetCard(0xa6c) and c:IsType(TYPE_MONSTER) and c:IsAbleToHand() and not c:IsCode(id)
end
