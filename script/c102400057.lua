...
function s.initial_effect(c)
	--This card's name becomes "Cyber Dragon" while on the field or in the GY. During the turn this card was sent to the GY, all monsters on the field become Machine monsters. If your "Cyber Dragon" monster(s) leaves the field, while this card is in your GY: You can banish this card; add 1 "Cyber Dragon" monster from your Deck to your hand. You can only use this effect of "Cyber Dragon Mach" once per turn.
