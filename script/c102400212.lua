...
function s.initial_effect(c)
	--1+ monsters with a Level, including a "Roman Keys" monster Must first be Fusion Summoned with a "Roman Keys" card effect. When this card is Fusion Summoned: You can target 1 monster on the field; shuffle it into the Deck. Once per turn (Quick Effect): You can Special Summon 1 "Roman Keys" monster from your GY or that is banished, except "Roman Keys - XXI".
	c:EnableReviveLimit()
...
function s.spop(e,tp,eg,ep,ev,re,r,rp)
	...
	Duel.SpecialSummon(Duel.SelectMatchingCard(tp,aux.NecroValleyFilter(s.filter),tp,LOCATION_GRAVE+LOCATION_REMOVED,0,1,1,nil,e,tp),0,tp,tp,false,false,POS_FACEUP)
end
