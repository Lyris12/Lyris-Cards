...
function s.initial_effect(c)
	--You can Special Summon this card (from your hand) to your opponent's field in Attack Position, then shift control to this card's owner during the End Phase. If this card is Normal or Special Summoned: Its owner targets 1 other card their opponent controls; destroy it, also, if this card was Summoned using its own procedure, negate the effect of your next Spell Card or effect that resolves this turn. You can only use this effect of "Rigil Rintaurus" once per turn.
