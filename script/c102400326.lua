...
function s.initial_effect(c)
	--During your opponent's End Phase, if they control a monster that did not change its battle position this turn: You can Special Summon this card from your hand. You can reveal this card in your hand, and it will remain revealed until the end of the next turn; add 1 "Icybrctic" from your Deck to your hand. You can only use each effect of "Icybr Cydra" once per turn, and can only Special Summon another monster(s) of each Type up to twice until the end of your turn after you do so.
