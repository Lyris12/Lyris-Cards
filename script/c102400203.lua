...
function s.initial_effect(c)
	--(Quick Effect): You can banish this card from your GY; Fusion Summon any number of "Roman Keys" Fusion monsters from your Extra Deck, by banishing "Roman Keys" monsters from the GYs as the Fusion materials, but you cannot Summon monsters whose total Levels exceed the total Levels of the materials this way. You can only use this effect of "Roman Keys - XXXVI" once per turn.
