...
function s.initial_effect(c)
	--Fusion Summon 1 "Fated Hero" Fusion Monster from your Extra Deck, using monsters from your hand or field as Fusion Material. You can only activate 1 "Fated Hero Fusion" per turn.
