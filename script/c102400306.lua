...
function s.initial_effect(c)
	--Reveal the top card of your Deck, and if you do, banish it face-down, then apply 1 of the following effects, based on the banished card. ● Monster: Banish 1 card your opponent controls face-down. ● Spell: Negate the effects of 1 face-up card your opponent controls. ● Trap: Banish 1 random card from your opponent's hand. If this card is banished: You can return all your banished monsters to the GY. You can only use this effect of "Chaos Transcendence" once per turn.
