...
function s.initial_effect(c)
	--1 Spell + Standby Phase Cards in your GY are unaffected by the effects of your opponent's monsters, unless their monster(s) is Level 5 or higher. Once per turn (Quick Effect): You can target 1 Level 5 or higher monster on the field; banish it until the End Phase.
	c:EnableReviveLimit()
