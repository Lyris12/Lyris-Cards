...
function s.initial_effect(c)
	--If this card is banished: You can Special Summon this card, and if you do, destroy 1 card your opponent controls. You can Tribute this card, then target 1 DARK monster with 1500 or less ATK that is banished or in your GY; add that target to your hand. You can only use each effect of "Weapon from the Rift" once per turn.
