...
function s.initial_effect(c)
	--U-If a "Blitzkrieg" Monster Card(s) is destroyed: You can Special Summon this card, and if you do, any "Blitzkrieg" monster that leaves the field for the rest of this turn is treated as being destroyed.
	--M-If your opponent declares an attack that targets this card: Negate the attack, also destroy this card, then destroy 1 Spell/Trap your opponent controls.
