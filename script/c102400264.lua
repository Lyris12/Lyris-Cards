...
function s.initial_effect(c)
	--When this card is activated: Destroy 1 other card on the field. If your "Armarine" monster battles, your opponent cannot activate cards or effects until the end of the Damage Step. Once per turn: You can target 1 "Armarine" monster you control with a Level; destroy 1 "Armarine" monster in your hand, and if you do, increase or reduce that target's Level by up to the destroyed monster's Level (min. 1).
