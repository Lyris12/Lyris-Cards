...
function s.initial_effect(c)
	--If this card is Normal or Special Summoned: All "Icybr" monsters currently on the field gain 500 ATK. If this card is sent to the GY: You can activate this effect; you can only Special Summon monsters of each Type up to twice until the end of the next turn, also add 1 "Icybr" Spell/Trap from your Deck to your hand, or, if it is your opponent's turn and they controlled a monster that did not change its battle position this turn when you activated this effect, you can add 1 "Icybr" monster instead, except "Icybr Indora". You can only use this effect of "Icybr Indora" once per turn.
