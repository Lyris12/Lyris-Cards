...
function s.initial_effect(c)
	--When a "Fated Hero" Fusion Monster you control is targeted for an attack: You can negate the attack. You can banish this card from your GY; Special Summon 1 "Fated Hero" monster from your hand. You can only use each effect of "Fated Hero Liberty" once per turn.
...
function s.condition(e,tp,eg,ep,ev,re,r,rp)
	...
	return tc:IsControler(tp) and tc:IsPosition(POS_FACEUP) and tc:IsSetCard(0xa5f)
end
