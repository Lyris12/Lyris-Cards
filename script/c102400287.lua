...
function s.initial_effect(c)
	--2 monsters with different Types, except Tokens If this card is banished by your "Antemattr" card or your opponent: You can target 1 card on the field; shuffle it into the Deck.
	c:EnableReviveLimit()
