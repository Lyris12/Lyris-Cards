...
function s.initial_effect(c)
	--Fusion Summon 1 Fusion Monster from your Extra Deck, using monsters from your hand or field as Fusion Materials, then if any face-up cards are on the field other than this card and the monster Summoned by it, they become unaffected by card effects, except their own. You can only activate 1 "Fusion Exboom" per turn.
