...
function s.initial_effect(c)
	--You can target 1 "YC.Org" monster in your GY; Banish it, and if you do, Special Summon 1 "YC.Org" monster from your hand. If this card or a "YC.Org" monster you control is destroyed or banished: You can excavate the top 3 cards of your Deck, add 1 excavated "YC.Org" card from among them to your hand, also shuffle the rest into the Deck. You cannot Special Summon monsters the turn you activate this effect, except "YC.Org" monsters. You can only use each effect of "YC.Org Research Database" once per turn.
