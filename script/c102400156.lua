...
function s.initial_effect(c)
	--(This card is always treated as an "Artifact" card.) You can Set this card from your hand to your Spell & Trap Zone as a Spell. During your opponent's turn, if this Set card in the Spell & Trap Zone is destroyed and sent to your GY: Special Summon it. If this card is Special Summoned during your opponent's turn: Set 1 "Artifact" monster directly from your Deck to your Spell & Trap Zone as a Spell. (Quick Effect): You can target any number of your Set Spells/Traps; Special Summon this card from your hand, then shuffle them into the Deck, or destroy them.
