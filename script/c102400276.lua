...
function s.initial_effect(c)
	--When this card is activated: Add 1 "Armarine" card from your Deck to your hand, except "Armarine Lighthouse". You can only activate 1 "Armarine Lighthouse" per turn. If an attack is declared involving your "Armarine" monster: Shuffle 1 "Armarine" monster with a different name than that monster from your GY or that is banished into the Deck, and if you do, you take no battle damage from that battle. You can only control 1 "Armarine Lighthouse".
