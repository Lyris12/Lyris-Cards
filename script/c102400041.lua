...
function s.initial_effect(c)
	--If all your monsters are "Entrafor" monsters (min. 1): You can Special Summon this card from your hand. If your "Entrafor" monster destroys a card(s) by battle or effect: You can attach this card to 1 of your Xyz Monsters, then Special Summon 1 "Entrafor" monster attached to an Xyz Monster you control, except "Rabbit Entraformer".
...
function s.condition(e,tp,eg,ep,ev,re,r,rp)
	...
	return rc:IsControler(tp) and rc:IsSetCard(0xc74)
		and eg:IsExists(s.dfilter,1,nil)
end
