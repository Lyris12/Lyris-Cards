...
function s.initial_effect(c)
	--If this card attacks a Defense Position monster, inflict piercing battle damage. Gains 100 ATK for each "Swordsmaster" monster in the GY. If this card is sent to the GY: Target 1 Spell/Trap you control and 1 "Swordsmaster" monster in your GY, except "Swordsmasterror Siegfried"; destroy the first target and Special Summon the second target. You can only use this effect of "Swordsmasterror Siegfried" once per turn.
