...
function s.initial_effect(c)
	--2 LIGHT monsters with 1100 or less DEF During your Main Phase: You can excavate the bottom 5 cards of your opponent's Deck, and if you do, place the excavated cards on top of your Deck in any order, then you can Special Summon LIGHT monsters, including an "uken" monster, with 1000 or more DEF and different names and Types from your GY, up to the number of excavated LIGHT/Spell/Trap "uken" cards. You can place 1 card from your hand or field on the bottom of the Main Deck; Special Summon 1 "Shouryuken" monster from your GY. You can only use each effect of "Undying Hadouken" once per turn.
...
function s.filter(c,e,tp)
	return c:IsSetCard(0x1d10) and c:IsCanBeSpecialSummoned(e,0,tp,false,false)
end
