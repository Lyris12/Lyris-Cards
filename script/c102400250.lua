...
function s.initial_effect(c)
	--If there are no monsters on the field, you can Special Summon this card (from your hand) to your opponent's field by revealing 1 Machine "Cyber" monster in your hand, except "Parasite Cybern". You can only Special Summon "Parasite Cybern" once per turn this way. This card's name becomes "Cyber Dragon" while in the Deck or GY. If this card is Special Summoned: Its owner Sets 1 "Cyber" Spell/Trap directly from their Deck. You can only use this effect of "Parasite Cybern" once per turn.
