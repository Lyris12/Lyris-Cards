...
function s.initial_effect(c)
	--This card's Level is doubled during the turn it is Summoned. When this card is Summoned: You can Special Summon 1 "Roman Keys" monster from your hand or Deck, except "Roman Keys - XXIV". You cannot Special Summon monsters from the Extra Deck the turn you use this effect, except "Roman Keys" monsters.
