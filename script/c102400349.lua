...
function s.initial_effect(c)
	--Choose monsters your opponent controls, up to the number of your "Icybr" cards with different names in the GY and revealed in the hand, and until the end of this turn, your opponent cannot use those monsters as Ritual, Fusion, Synchro, Xyz, or Link Material. You can only Special Summon a monster(s) of each Type up to twice until the end of the next turn. You can only activate 1 "Icybrightness" per turn.
