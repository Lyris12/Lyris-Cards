...
function s.initial_effect(c)
	--All your monsters gain 200 ATK for each "Entrafor" monster with different names attached to your Xyz Monsters. Once per turn (Quick Effect): You can attach this card from your hand or field to 1 of your Xyz Monsters, then that monster gains 400 ATK/DEF for each "Entrafor" monster with different names attached to your Xyz Monsters until the end of this turn.
