...
function s.initial_effect(c)
	--If this card destroys a card by battle or inflicts battle damage to your opponent: You can attach this card to 1 of your Xyz Monsters, then Special Summon 1 "Entrafor" monster attached to an Xyz Monster you control, except "Alice the Entraformer". An "Entraforemost" Xyz Monster who has this card as material gains this effect. ● If this card destroys a card(s) by battle or effect: You can Special Summon 1 "Entrafor" monster attached to this card, except "Alice the Entraformer".
