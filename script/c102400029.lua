...
function s.initial_effect(c)
	--Excavate 3 cards from the bottom of your Deck, and if you do, add 1 excavated "Hadouken" or "Shouryuken" card to your hand, except "Hadouken Ark Box", also place the other excavated the cards on top of the Deck in any order.
...
function s.filter(c)
	return c:IsSetCard(0x1d10) and not c:IsCode(id)
end
