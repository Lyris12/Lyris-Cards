...
function s.initial_effect(c)
	--U-If a "Blitzkrieg" Monster Card(s) is destroyed: You can target 1 "Blitzkrieg" monster in your GY, except "Blitzkrieg Dragon - Glass"; destroy this card, then Special Summon that target. You can only use 1 "Blitzkrieg Dragon - Glass" effect per turn, and only once that turn.
	--M-If your opponent declares an attack that targets this card: Negate the attack, also destroy this card, then destroy 1 monster your opponent controls. If this card is destroyed: You can target 1 "Blitzkrieg" monster in your GY, except "Blitzkrieg Dragon - Glass"; Special Summon that target, but destroy it at the end of this turn. You can only use 1 "Blitzkrieg Dragon - Glass" effect per turn, and only once that turn.
...
function s.tg(e,tp,eg,ep,ev,re,r,rp,chk,chkc)
	...
	if chk==0 then return Duel.GetLocationCount(tp,LOCATION_MZONE)>0
		and Duel.IsExistingTarget(s.filter,tp,LOCATION_GRAVE,0,1,nil,e,tp) and (e:IsHasType(EFFECT_TYPE_SINGLE) or e:GetHandler():IsDestructable()) end
