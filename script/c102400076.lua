...
function s.initial_effect(c)
	--If this card attacks a Defense Position monster, inflict piercing battle damage. If this card is Summoned: You can shuffle 3 "Swordsmaster" cards from your hand and/or GY into the Deck, and if you do, draw 1 card. You can only use this effect of "Winged Swordsmaster Tara" once per turn. A "Swordsmaster" Xyz Monster that has this card as material gains this effect. ● Once per turn (Quick Effect): You can detach 1 material from this card, then target any number of "Swordsmaster" monsters in your GY; shuffle them into the Deck, then you can change monsters on the field to face-down Defense Position, up to the number of monsters that left the GY this way.
