...
function s.initial_effect(c)
	--1+ monsters with a Level, including a "Roman Keys" monster Must first be Fusion Summoned with a "Roman Keys" card effect. At the end of your Battle Phase, if all other monsters you control are "Roman Keys" monsters (min. 1) (Quick Effect): You can banish this card you control, then target 1 monster your opponent controls; banish it, then, immediately after this effect resolves, skip to the Battle Phase of your next turn. Neither player can activate cards or effects in response to this effect's activation. You can only use this effect of "Roman Keys - XXXIII" once per Duel.
	c:EnableReviveLimit()
