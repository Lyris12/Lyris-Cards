...
function s.initial_effect(c)
	--1 Tuner + 1+ non-Tuner monsters For this card's Synchro Summon, you can treat 1 "Armarine" monster as a Tuner. Once per turn: You can return any number of "Armarine" monsters (max. 3, unless 3 or more attacks were declared this turn or the previous turn) from your GY into the Deck, and if you do, this turn, you can make attacks on monsters with "Armarine" monsters up to the number of cards that left the GY this way. If this card is destroyed: Draw 1 card.
