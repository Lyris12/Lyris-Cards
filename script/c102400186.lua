...
function s.initial_effect(c)
	--When a LIGHT Warrior Fusion Monster you control is destroyed by battle or card effect, while this card is in your GY: You can Special Summon this card, and if you do, its Level becomes equal to the destroyed monster's, but banish it when it leaves the field. You can only use this effect of "Fated Hero Botsa" once per turn.
