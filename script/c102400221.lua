...
function s.initial_effect(c)
	--When this card is activated: You can add 1 "YC.Org" monster from your Deck to your hand. If this card is destroyed: You can Special Summon 1 "YC.Org" monster from your hand or GY. If a non-Link "YC.Org" monster you control would be destroyed by your opponent's card effect, you can destroy this card instead. You can only activate 1 "YC.Org Registration" per turn.
