...
function s.initial_effect(c)
	--(This card's name is always treated as "The Wave of Light".) When your opponent activates a monster effect or declares an attack: Negate the activation (if any) and effects of that monster, and if you do, take damage equal to that negated monster's original ATK, and if you do that, 1 monster you control gains ATK equal to the damage you took.
