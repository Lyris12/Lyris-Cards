...
function s.initial_effect(c)
	--Once per turn, during damage calculation, if this card battles (Quick Effect): You can Special Summon 1 "Armarine" monster from your Deck with a different name from the monster you control and/or in your GY, then destroy this card. If this card is destroyed by a card effect: Add 1 "Armarine" card from your Deck to your hand, except "Armarine Sea Lion". You can only use this effect of "Armarine Sea Lion" once per turn.
