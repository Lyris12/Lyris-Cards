...
function s.initial_effect(c)
	--Cannot be Normal Summoned/Set. Must first be Special Summoned (from your hand) by sending 1 other "Inlightened" monster from your hand to the GY and Tributing 1 "Inlightened Elma Arms". If your "Inlightened" monster battles, after damage calculation: This card gains 1000 ATK, also send all of your opponent's monsters to the GY if you attacked directly. You can only control 1 "Inlightened Ultima" monster.
	c:EnableReviveLimit()
...
function s.desop(e,tp,eg,ep,ev,re,r,rp)
	...
	if dir then Duel.SendtoGrave(Duel.GetMatchingGroup(aux.TRUE,tp,0,LOCATION_MZONE,nil),REASON_EFFECT) end
end
