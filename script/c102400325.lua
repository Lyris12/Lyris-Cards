...
function s.initial_effect(c)
	--1 Fairy monster + 1 DARK monster You can banish 1 Fairy monster from your GY; add 1 monster with the same name from your Deck to your hand. If this card inflicts battle damage: Gain LP equal to the damage inflicted, also, this card gains ATK and DEF equal to the damage inflicted until the end of this turn, then it can make another attack in a row. You can only use each effect of "Great Reaper" once per turn.
	c:EnableReviveLimit()
