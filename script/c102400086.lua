...
function s.initial_effect(c)
	--Target 1 Xyz Monster you control; Special Summon from your Extra Deck, 1 DARK Warrior monster that is 1 Rank higher than that target by using that target as the material. (This Special Summon is treated as an Xyz Summon. Transfer its materials to the Summoned monster.) You can banish this card from your GY, then target 1 DARK Warrior Xyz Monster you control; detach 1 material from a monster your opponent controls and attach it to that monster you control as a material.
