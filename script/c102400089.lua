...
function s.initial_effect(c)
	--If a monster(s) on the field is destroyed while there is another card with the same name as that monster(s) on the field: You can Special Summon this card from your hand. If Summoned this way: Negate the effects of all face-up cards your opponent controls, then you can change all your opponent's monsters to Defense Position.
