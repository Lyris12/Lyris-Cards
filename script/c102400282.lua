...
function s.initial_effect(c)
	--If this card is Normal or Special Summoned: You can change the Attribute of this card. During your Main Phase: You can banish 1 of your opponent's monsters with the same Attribute as 1 of your face-up monsters. You can only use this effect of "Antemattr Divinr" once per turn. 
