...
function s.initial_effect(c)
	--"Icybrctic" in your Field Zone is unaffected by card effects, except its own and this card's. If this card is in your GY, except the turn it was sent there: You can banish this card; activate 1 "Icybrctic" directly from your Deck, but you can only Special Summon a monster(s) of each Type up to twice until the end of the next turn. You can only use this effect of "Icybrrier" once per turn. You can only control 1 "Icybrrier"
