...
function s.initial_effect(c)
	--2 Level 4 monsters with different Types If this card is Xyz Summoned: You can add 1 "Entraformer" monster from your Deck to your hand, then you can destroy 1 Spell/Trap your opponent controls. (Quick Effect): You can Tribute 1 other "Entrafor" monster from your hand or field; attach the top 2 cards of your Deck to 1 of your "Entraforemost" Xyz Monsters, then Special Summon 1 "Entraformer" monster attached to your Xyz Monster, and it gains 800 ATK. You can only use each effect of "Entraforemost Farrah" once per turn.
	c:EnableReviveLimit()
