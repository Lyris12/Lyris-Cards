...
function s.initial_effect(c)
	--If this card or another "Strata" or "YC.Org" is Normal or Special Summoned under your control: You can send 1 "Strata" or "YC.Org" card from your Deck to the GY. If you control this card: You can Special Summon up to 1 "Strata" or "YC.Org" monster from your hand. You can activate this effect as a Quick Effect by tributing this card. You can only use each effect of "Stratauramram, YC.Org Pilot" once per turn.
