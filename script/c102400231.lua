...
function s.initial_effect(c)
	--U-You can reveal 2 "Paintress" and/or "YC.Org" cards in your hand with different names: Destroy this card, and if you do, add 1 "Paintress" or "YC.Org" card from your Deck to your hand, also for the rest of this turn you cannot Special Summon monsters, except "Paintress" and "YC.Org" monsters. You can only use this effect of "Chahine, Paintress of YC.Org" once per turn.
	--M-Fervently Passionate, they stand by their decisions despite all protest.
