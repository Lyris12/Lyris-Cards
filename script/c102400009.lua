...
function s.initial_effect(c)
	--You can discard this card; add 1 "Inlightened Psychic Helmet" from your Deck to your hand. Your other "Inlightened" monsters cannot be destroyed by battle. If your "Inlightened" monster attacks, after damage calculation: For the rest of this turn, you take no battle damage, also if you attacked directly, you take no effect damage. These changes last until the end of the next turn.
