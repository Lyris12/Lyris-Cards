...
function s.initial_effect(c)
	--3 Level 5 monsters / If this card attacks a Defense Position monster, inflict piercing battle damage. Gains 200 ATK for each material attached to it and 100 ATK for each "Swordsmaster" monster in the GY. If this card is sent to the GY: You can target up to 2 "Swordsmaster" Xyz Monsters in your GY, except "CXyz Swordsmasterror Genghis"; Special Summon those targets, then you can attach 1 "Swordsmaster" monster from your GY to each target as a material, except "CXyz Swordsmasterror Genghis". You can only use this effect of "CXyz Swordsmasterror Genghis" once per turn. Gains this effect, while it has a "Swordsmaster" monster as a material. ● Once per turn, if a "Swordmaster" monster is sent to the GY while you control this face-up card: You can detach 1 material from this card, then target 1 "Swordmaster" monster in your GY, except "CXyz Swordmasterror Genghis"; Special Summon that target.
	c:EnableReviveLimit()
