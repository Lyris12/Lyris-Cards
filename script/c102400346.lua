...
function s.initial_effect(c)
	--Your opponent cannot declare an attack unless they control more monsters that can attack than the number of "Icybr" cards revealed in your hand, also they cannot change their monsters' battle positions. You can reveal 1 "Icybr" monster in your hand, and it will remain revealed until the end of the next turn; Special Summon 1 "Icybr" monster from your GY with a different name than the monsters you control and revealed in your hand, but you can only Special Summon monster(s) of each Type up to twice for the rest of this turn. You can only use this effect of "Icybrctic" once per turn.
