...
function s.initial_effect(c)
	--If your opponent controls a monster: You can Special Summon this card from your hand. During your Main Phase: You can have your opponent shuffle their Deck, then each player excavates the bottom 3 cards of their Deck, and if they do, they Set 1 excavated monster with 1000 or more ATK to their opponent's field, also, you place the rest on top of the Decks in any order. You can only use each effect of "Sniper Hadouken" once per turn.
...
function s.destg(e,tp,eg,ep,ev,re,r,rp,chk,chkc)
	...
	if chk==0 then return Duel.GetFieldGroupCount(tp,LOCATION_DECK,0)>=ct
		and Duel.IsExistingMatchingCard(Card.IsSetCard,tp,LOCATION_DECK,0,1,nil,0x1d10) end
end
