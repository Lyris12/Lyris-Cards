...
function s.initial_effect(c)
	--U-If a "Blitzkrieg" Monster Card(s) is destroyed: You can Fusion Summon 1 "Blitzkrieg" Fusion Monster from your Extra Deck, by destroying this card as Fusion Material, as well as other monsters on your field and/or face-up in your Extra Deck. You can only use this effect of "Blitzkrieg Element - PSYph" once per turn.
	--M-If your opponent declares an attack that targets this card: Negate the attack, also destroy this card, then destroy 1 monster your opponent controls.
...
function s.tg(e,tp,eg,ep,ev,re,r,rp,chk)
	local c=e:GetHandler()
	local dg=Duel.GetMatchingGroup(s.dfilter,tp,LOCATION_HAND,0,nil)
