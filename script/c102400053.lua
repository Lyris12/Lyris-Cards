...
function s.initial_effect(c)
	--An "Entraforemost" Xyz Monster who has this card as material gains this effect. ● Once per turn (Quick Effect): You can target 1 card your opponent controls; Special Summon 1 "Dynamite Entraformer" attached to this card, then destroy that target.
