...
function s.initial_effect(c)
	--Up to twice per turn, if your "Icybr" card(s) would be destroyed while "Icybr Maxi" is revealed in your hand, you can banish 1 "Icybr" card from your GY instead. During the Battle Phase (Quick Effect): You can Special Summon this card from your hand, and if you do, all your monsters gain 1000 ATK, then, if this effect was activated in response to your opponent activating a card or effect, that effect becomes "All monsters on the field gain 1000 ATK", also, destroy that card. You can only use this effect of "Icybr Maxi" once per turn.
