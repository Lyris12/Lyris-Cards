...
function s.initial_effect(c)
	--If you control a "Disstonant" or "YC.Org" monster: You can banish this card from your hand and target 1 "Disstonant" or "YC.Org" card in your GY; send 1 "YC.Org" or "Disstonant" monster from your Deck to the GY, except "Disstonant Meed, YC.Org Spymaster", and if you do, add that card to your hand. You can only use this effect of "Disstonant Meed, YC.Org Spymaster" once per turn.
