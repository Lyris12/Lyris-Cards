...
function s.initial_effect(c)
	--Activate this card by targeting 1 Level 3 or lower Dragon monster in the GY; Special Summon 1 "Cyberdark" Machine monster from your Deck, then equip this card and that target in the GY to the Summoned monster, as if it were equipped by that monster's effect. If the equipped monster would be destroyed, you can destroy this card instead.
