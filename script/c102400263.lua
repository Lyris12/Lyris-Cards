...
function s.initial_effect(c)
	--Destroy 1 "Armarine" monster in your hand or field, and if you do, draw 2 cards, then you can destroy up to the top 2 cards of your Deck. You can only activate 1 "Armarine Sacrifice" per turn. If your opponent Summons a monster(s): You can banish this card from your GY; send 1 of those monsters to the GY, then destroy 1 "Armarine" monster in your hand or field.
