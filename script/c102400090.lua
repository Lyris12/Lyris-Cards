...
function s.initial_effect(c)
	--If a card(s) on the field is destroyed, except "Stonebreaker Dragon": You can Special Summon this card from your hand in Defense Position. If Summoned this way: Target 1 monster in your GY; Special Summon it in Defense Position, then destroy this card, and if you do that, banish this card. You can only use this effect of "Stonebreaker Dragon" once per turn.
