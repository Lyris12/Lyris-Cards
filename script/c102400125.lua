...
function s.initial_effect(c)
	--2+ Dragon monsters, including at least 1 LIGHT and 1 DARK monster / Once per turn (Quick Effect): You can destroy this card, and if you do, Special Summon 1 Level 5 or lower "Blitzkrieg" monster from your hand or GY. Unaffected by card effects that target it and cannot be targeted for attacks, while you control a Level 5 or lower "Blitzkrieg" monster. If another "Blitzkrieg" Monster Card(s) is destroyed: You can target Spells/Traps your opponent controls, up to the number of monsters this card points to; destroy monsters on the field equal to the number of Spells/Traps you targeted. You can only use this effect of "Blitzkrieg Meknight Dragon - Eclipse" once per turn.
	c:EnableReviveLimit()
