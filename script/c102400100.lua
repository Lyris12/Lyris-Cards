...
function s.initial_effect(c)
	--U-If a "Blitzkrieg" Monster Card(s) is destroyed: You can target 1 "Blitzkrieg" Spell/Trap or "Blitz Field" in your GY; Set it. You can only use 1 "Blitzkrieg Dragon - Light" effect per turn, and only once that turn.
	--M-If your opponent declares an attack that targets this card: Negate the attack, also destroy this card, then destroy 1 monster your opponent controls. If this card is destroyed: You can target 1 "Blitzkrieg" Spell/Trap or "Blitz Field" in your GY; Set it. You can only use 1 "Blitzkrieg Dragon - Light" effect per turn, and only once that turn.
...
function s.tg(e,tp,eg,ep,ev,re,r,rp,chk,chkc)
	if chkc then return chkc:IsControler(tp) and chkc:IsLocation(LOCATION_GRAVE) and s.setfilter(chkc,e,tp) end
