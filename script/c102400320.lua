...
function s.initial_effect(c)
	--U-You can Special Summon Pendulum Monsters from your Extra Deck to unlinked Main Monster Zones. If this card is activated: You can Special Summon 1 Level 6 or lower "Rokket" monster from your Deck. If you Pendulum Summon a DARK Dragon monster(s): You can Special Summon 1 "Rokket" monster from your Deck, with a Level lower than the highest Level among those Pendulum Summoned monster(s).
	--M-If you control a DARK Dragon monster and a LIGHT Dragon monster, you can Special Summon this card (from your hand). Neither player can Link Summon.
