...
function s.initial_effect(c)
	--"Icybr" monsters can make a second attack during each Battle Phase, while this card is Special Summoned or revealed in the hand. If an "Icybr" monster(s) is Special Summoned: You can activate this effect; you can only Special Summon another monster(s) of each Type up to twice until the end of the next turn, also Special Summon this card from your hand. You can only use this effect of "Icybr Gartha" once per turn.
