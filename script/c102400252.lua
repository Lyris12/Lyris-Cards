...
function s.initial_effect(c)
	--During damage calculation, if your other monster battles while this card is in your hand or field (Quick Effect): You can have that monster gain 1400 ATK, then destroy 1 card in your hand. You can only use this effect of "Armarine Soldier of Spirit" once per turn. If this card is destroyed by a card effect: All your current monsters gain 1000 ATK.
