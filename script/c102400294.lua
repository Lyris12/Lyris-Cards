...
function s.initial_effect(c)
	--Banish 1 "Antemattr" monster from your field or GY; Special Summon 1 "Antemattr" monster with a different name than that monster from your Deck. You can only activate 1 "Antemattr Division" per turn.
