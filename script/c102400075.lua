...
function s.initial_effect(c)
	--If this card attacks a Defense Position monster, inflict piercing battle damage. If you take damage: You can Special Summon this card from your hand. If Summoned this way, and your opponent controls more monsters than you do: You can Special Summon "Swordsmaster" monsters with different names from your Deck or GY, up to their surplus. You can only use this effect of "Winged Swordsmaster Shinob" once per Duel. A "Swordsmaster" Xyz Monster that has this card as material gains this effect. ● If this card battles a monster, your opponent cannot activate cards or effects until the end of the Damage Step.
