...
function s.initial_effect(c)
	--2 monsters with different Levels, except Tokens If this card is Spatial Summoned: You can banish 1 "Antemattr" card from your hand or GY; if an "Antemattr" monster attacks a Defense Position monster this turn, inflict piercing battle damage.
	c:EnableReviveLimit()
