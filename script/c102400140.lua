...
function s.initial_effect(c)
	--Target 1 monster you control; destroy it, and if you do, Special Summon 1 "Blitzkrieg" monster from your Deck with the same Level as the destroyed monster's Level on the field. You can only activate 1 "Blitzkrieg Calling Ritual" per turn.
