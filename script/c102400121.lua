...
function s.initial_effect(c)
	--1 "Blitzkrieg" monster + 1 "Blitzkrieg" monster with lower ATK (max. 400) / Once per turn (Quick Effect): You can destroy this card, and if you do, negate the next attack this turn from a monster your opponent controls, also Special Summon 1 Level 5 or lower "Blitzkrieg" monster from your hand or GY. Unaffected by card effects that target it and cannot be targeted for attacks, while you control a Level 5 or lower "Blitzkrieg" monster. When your opponent activates a card or effect (Quick Effect): You can negate the effect, and if you do, shuffle both that card and 1 "Blitzkrieg" Pendulum monster in your GY into the Deck. You can only use this effect of "Blitzkrieg Meknight Dragon - Big Bang Eon" once per turn.
	c:EnableReviveLimit()
