...
function s.initial_effect(c)
	--(Quick Effect): You can discard this card; you can only Special Summon a monster(s) of each Type up to twice until the end of the next turn, also, add 1 "Icybr" monster from your GY to your hand, except "Icybr Altri", or, if it is your opponent's turn, you can add from your Deck instead, but during the End Phase, discard all copies of the card added from the Deck this way unless your opponent controls a monster that did not attack this turn. You can only use this effect of "Icybr Altri" once per turn.
