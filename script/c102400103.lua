...
function s.initial_effect(c)
	--U-If a "Blitzkrieg" Monster Card(s) is destroyed: You can target 1 DARK "Blitzkrieg" monster in your GY; Special Summon that target. You can only use 1 "Blitzkrieg Meknight - Dusk" effect per turn, and only once that turn.
	--M-If your opponent declares an attack that targets this card: Negate the attack, also destroy this card, then destroy 1 Spell/Trap your opponent controls. If this card is destroyed: You can target 1 LIGHT "Blitzkrieg" monster in your GY; Special Summon that target. You can only use 1 "Blitzkrieg Meknight - Dusk" effect per turn, and only once that turn.
