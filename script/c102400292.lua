...
function s.initial_effect(c)
	--2 monsters with different Levels, except Tokens If this card is banished by your "Antemattr" card or your opponent: You can activate this effect; if an "Antemattr" monster attacks a Defense Position monster this turn, inflict piercing battle damage.
	c:EnableReviveLimit()
