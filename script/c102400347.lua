...
function s.initial_effect(c)
	--Target up to 5 "Icybr" monsters with different names in your GY; you can only Special Summon a monster(s) of each Type up to twice for the rest of this turn, also, add 1 of them to your hand, and if you do, it will remain revealed until the end of the next turn, also, shuffle the rest of those monsters (if any) into the Deck, then if 2 or more monsters were shuffled this way, draw 1 card. You can only activate 1 "Icybrink" per turn.
