...
function s.initial_effect(c)
	--(Quick Effect): You can banish this card you control; Fusion Summon any number of "Roman Keys" Fusion monsters from your Extra Deck, using "Roman Keys" monsters from your field as the Fusion materials, which can also include 1 face-up monster your opponent controls, but you cannot Summon monsters whose total Levels exceed the total Levels of the materials this way. You can only use this effect of "Roman Keys - XVIII" once per turn.
