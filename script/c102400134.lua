...
function s.initial_effect(c)
	--Once per turn, during the End Phase: Destroy all monsters that were Special Summoned from the Extra Deck, except LIGHT, DARK, and Fusion Monsters. If a monster(s) you control is destroyed by battle or card effect: You can Special Summon 1 "Blitzkrieg" monster from your Deck. You can only use this effect of "Blitzkrieg Bombardment" once per turn.
...
function s.desop(e,tp,eg,ep,ev,re,r,rp)
	...
	Duel.Destroy(Duel.GetMatchingGroup(s.desfilter,tp,LOCATION_MZONE,LOCATION_MZONE,nil),REASON_EFFECT)
end
