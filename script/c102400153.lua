...
function s.initial_effect(c)
	--3 Level 5 monsters with different Types You can also Xyz Summon this card using 1 Rank 4 "Entraforemost" Xyz Monster you control. (Transfer its materials to this card.) (Quick Effect): You can Special Summon any number of "Entraformer" monsters with different Types attached to your Xyz Monsters, also for the rest of this turn after this effect Summons more than 1 monster at the same time, you can only Special Summon a non-"Entraforemost" monster from the Extra Deck once. You can only use this effect of "Entraforemost Lucy" once per turn. If this card attacks a Defense Position monster, inflict piercing battle damage.
