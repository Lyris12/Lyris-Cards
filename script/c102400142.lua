...
function s.initial_effect(c)
	--During your Main Phase: You can destroy 1 "Blitzkrieg" monster in your hand or face-up in your Monster Zone, then apply 1 of the following effects. ● Add 1 "Blitzkrieg" monster from your Deck to your hand, except a monster with the same name as the monster destroyed by this effect. ● Destroy 1 Spell/Trap on the field. ● Shuffle 1 of your banished "Blitzkrieg" monsters into the Deck. If this card is destroyed: Destroy all monsters you control. You can only use each effect of "Blitz Field" once per turn.
