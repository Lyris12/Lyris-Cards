...
function s.initial_effect(c)
	--Target 1 monster your opponent controls; place 1 Ice Counter on it. While that monster has an Ice Counter on it, take control of it, also replace its effects with "Cannot attack, or be Tributed or used as a material. Once per turn: You can remove 1 Ice Counter from anywhere on the field, then target 1 other monster on the field; it loses 1500 ATK, then if it has 0 ATK, send it to the GY, and if you do, place 1 Ice Counter on this card.".
