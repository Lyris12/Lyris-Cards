...
function s.initial_effect(c)
	--1 Tuner + 1+ non-Tuner WATER monsters For this card's Synchro Summon, you can treat 1 "Armarine" monster as a Tuner. Your opponent cannot target this card with card effects. During the Main or Battle Phase (Quick Effect): You can draw 1 card, then if 4 or more attacks were declared this turn or the previous turn, you can banish 1 other card on the field. You can only use each effect of "Armarine Dragon of the Storm" once per turn.
