...
function s.initial_effect(c)
	--3 Level 5 "Entrafor" monsters You can also Xyz Summon this card using 1 Rank 4 "Entraforemost" Xyz Monster you control. (Transfer its materials to this card.) If this card is Xyz Summoned: You can Special Summon 1 "Entraformer" monster attached to this card. You can only use this effect of "Entraforemost Huricane" once per turn. Gains 100 ATK/DEF for each "Entrafor" monster attached to your Xyz Monsters. Once per battle, during damage calculation, if this card attacks an Attack Position monster (Quick Effect): You can apply its DEF for damage calculation.
	c:EnableReviveLimit()
