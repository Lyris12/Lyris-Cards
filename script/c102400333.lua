...
function s.initial_effect(c)
	--Return control of all "Rigil" monsters on the field to their owners. You cannot Special Summon monsters during the turn you activate this card, except "Rigil" monsters. You can only activate 1 "Rigil Riturn" per turn.
