...
function s.initial_effect(c)
	--If this card is Special Summoned from being attached to your Xyz Monster: You can Special Summon 1 "Entrafor" monster attached to an Xyz Monster on the field (except "Cereberus Entraformer"), then attach the top card of your Deck to that Xyz Monster.
