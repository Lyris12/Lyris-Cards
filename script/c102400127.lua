...
function s.initial_effect(c)
	--2 LIGHT and/or "Blitzkrieg" monsters Once per turn (Quick Effect): You can destroy this card, and if you do, Special Summon 1 Level 5 or lower "Blitzkrieg" monster from your hand or GY. Unaffected by card effects that target it and cannot be targeted for attacks, while you control a Level 5 or lower "Blitzkrieg" monster. When this card is Fusion Summoned: You lose 3000 LP. If another monster(s) on the field is destroyed, except by the effect of "Blitzkrieg Dragon - Spark Tsunami": Gain LP equal to the ATK of that monster(s), also if you gained 3000 or more LP with this effect this turn, destroy 1 "Blitzkrieg" monster you control.
	c:EnableReviveLimit()
