...
function s.target(e,tp,eg,ep,ev,re,r,rp,chk)
	...
	if chk==0 then return Duel.IsExistingMatchingCard(Card.IsSetCard,tp,LOCATION_DECK,0,1,nil,0x1d10,0x2d10) and #g>0
...
function s.activate(e,tp,eg,ep,ev,re,r,rp)
	...
	local d=g:FilterCount(Card.IsSetCard,nil,0x1d10,0x2d10)
