...
function s.initial_effect(c)
	--If this card attacks a Defense Position monster, inflict piercing battle damage. Gains 100 ATK for each "Swordsmaster" monster you control. If this card is Normal or Special Summoned: You can Special Summon 1 "Swordsmaster" monster from your hand, then you can Special Summon 1 "Swordsmaster" monster from your GY. A "Swordsmaster" Xyz Monster that has this card as material gains this effect. ● Double any battle damage this card inflicts your opponent if it attacks a Defense Position monster.
