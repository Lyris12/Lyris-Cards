...
function s.initial_effect(c)
	--At the start of your Main Phase 1: Special Summon 1 "Inlightened" monster from your Deck. During your Main Phase, except the turn this card was sent to the GY: You can banish this card from your GY; Fusion Summon 1 "Inlightened" monster from your Extra Deck, using monsters from your hand or field as Fusion Material. If your opponent controls a Special Summoned monster, you can also use monsters in your Deck as Fusion Materials. You can only use this effect of "Inlightened Assembly" once per turn.
