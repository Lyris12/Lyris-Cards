...
function s.initial_effect(c)
	--Return any number of "Armarine" monsters from your GY into the Deck, then Special Summon 1 "Armarine" Synchro Monster from your Extra Deck whose Level equals the total original Levels of the returned monster(s). (This is treated as a Synchro Summon.) You can only activate 1 "Armarine Tempest" per turn.
