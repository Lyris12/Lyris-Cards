...
function s.initial_effect(c)
	--If you draw this card while you control an "Entrafor" monster: You can Special Summon it in face-up Defense Position. Once per Chain, if all monsters you control are "Entrafor" monsters (Quick Effect): You can discard this card and 1 other "Entrafor" card from your hand (except "Rainbow Entraformer"), then draw 2 cards. You can only use this effect of "Rainbow Entraformer" once per turn. An "Entraforemost" Xyz Monster who has this card as material gains this effect. ● Once per turn (Quick Effect): You can attach 1 "Entraformer" monster from your hand to this card, then draw 2 cards.
