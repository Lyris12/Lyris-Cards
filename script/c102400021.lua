...
function s.initial_effect(c)
	--If your opponent controls more monsters than you do, and all your monsters (if any) are LIGHT "uken" monsters: You can Special Summon this card from your hand. During your Main Phase: You can have your opponent shuffle their Deck, then each player excavates the bottom 3 cards of their Deck, and if they do, they Set 1 excavated Trap to their opponent's field, also, you place the rest on top of the Decks in any order. You can only use each effect of "Seeker Hadouken" once per turn.
...
function s.filter(c)
	return c:IsFaceup() and c:IsSetCard(0x1d10)
end
function s.sfilter(c,e,tp)
	return c:IsSetCard(0x1d10) and c:IsCanBeSpecialSummoned(e,0,tp,false,false) and not c:IsCode(id)
end
