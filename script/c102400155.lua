...
function s.initial_effect(c)
	--Xyz Summon 1 Xyz Monster using monsters you control as materials, then Special Summon from your Extra Deck, 1 Xyz Monster with the same Type and Attribute as that monster you control but 1 Rank higher, using it as the Xyz Material. (This is treated as an Xyz Summon. Transfer its materials to the Summoned monster.)
