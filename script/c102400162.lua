--created by Lyris & Discord \ LeonDuvall
--YC.Orgの襲雷タクティシャン・ライリス
local s,id,o=GetID()
function s.initial_effect(c)
	--U-If a "YC.Org" or "Blitzkrieg" monster(s) you control is banished or destroyed by a card effect: You can Special Summon this card from your Pendulum Zone. You cannot Special Summon monsters the turn you activate this effect, except "Blitzkrieg" / "YC.Org" monsters. You can only use this effect of "Lyris, Blitzkrieg Tactician of YC.Org" once per turn.
	--M-If your opponent declares an attack that targets this card: Negate the attack, also destroy this card, then destroy 1 monster your opponent controls. If this card is Special Summoned OR if this face-up card is destroyed or banished: You can shuffle 3 "YC.Org" / "Blitzkrieg" cards from your GY and/or face-up Extra Deck into your Deck, and if you do, draw 1 card. You can only use this effect of "Lyris, Blitzkrieg Tactician of YC.Org" once per turn.
