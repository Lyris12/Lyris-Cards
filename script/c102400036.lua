...
function s.initial_effect(c)
	--2 monsters, except Tokens During your Main Phase 1: You can target 1 banished monster; its owner takes damage equal to its ATK, then return it to the GY. This card cannot attack during the turn you activate this effect. You can only use this effect of "Starry-Eyes Spatial Dragon" once per turn.
	c:EnableReviveLimit()
