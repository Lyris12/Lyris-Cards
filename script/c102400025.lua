...
function s.initial_effect(c)
	--2 LIGHT monsters with 1100 or less DEF During your Main Phase: You can excavate the bottom 5 cards of your opponent's Deck, and if you do, place them on top of the Deck in any order, then you can Special Summon Level 4 or lower monsters, including a LIGHT "uken" monster, with different names and Types from your GY, up to the number of excavated LIGHT/Spell/Trap "uken" cards. You can place 1 card from your hand or field on the bottom of your Main Deck; Special Summon 1 "Hadouken" monster from your GY. You can only use each effect of "Undying Hadouken" once per turn.
	c:EnableReviveLimit()
