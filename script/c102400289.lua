...
function s.initial_effect(c)
	--2 "Antemattr" monsters If this card is banished by your "Antemattr" card or your opponent: You can Special Summon 1 of your banished "Antemattr" monsters, except "Antemattr Pixie". You can only use this effect of "Antemattr Pixie" once per turn.
	c:EnableReviveLimit()
