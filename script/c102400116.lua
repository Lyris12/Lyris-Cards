...
function s.initial_effect(c)
	--U-If a "Blitzkrieg" Monster Card(s) is destroyed: You can Special Summon this card, then place 1 "Blitzkrieg" monster from your Deck in your Pendulum Zone. You can only use 1 "Blitzkrieg Dragon - Obsidian" effect per turn, and only once that turn.
	--M-If your opponent declares an attack that targets this card: Negate the attack, also destroy this card, then destroy 1 Spell/Trap your opponent controls. If this card is destroyed: You can place 1 "Blitzkrieg" monster from your Deck in your Pendulum Zone. You can only use 1 "Blitzkrieg Dragon - Obsidian" effect per turn, and only once that turn.
