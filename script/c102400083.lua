...
function s.initial_effect(c)
	--If this card attacks a Defense Position monster, inflict piercing battle damage. Gains 100 ATK for each "Swordsmaster" monster in the GY. If this card is sent to the GY: Add 1 "Swordsmaster" monster from your Deck to your hand. You must have another "Swordsmaster" monster in your GY in order to resolve this effect. You can only use this effect of "Swordsmasterror Tiberius" once per turn.
