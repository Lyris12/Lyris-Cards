...
function s.initial_effect(c)
	--1 Tuner + 1+ non-Tuner "Armarine" monsters For this card's Synchro Summon, you can treat 1 "Armarine" monster as a Tuner. Once per turn (Quick Effect): You can target 1 "Armarine" monster you control; this turn, it cannot be destroyed by battle or card effects, also, it is unaffected by your opponent's card effects if 4 or more attacks were declared this turn or the previous turn.
