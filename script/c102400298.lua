...
function s.initial_effect(c)
	--You can target 1 banished card; banish 1 card its owner controls, then Set that target to its owner's field (if possible). You can only use this effect of "Antemattr Cloud" once per turn.
