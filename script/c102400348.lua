...
function s.initial_effect(c)
	--1 "Icybr" monster + 1 WATER monster Must first be Special Summoned (from your Extra Deck) by Tributing the above cards you control with different Types. You can only Special Summon a monster(s) of each Type up to twice per turn. Your opponent cannot activate cards or effects during your Battle Phase. If your "Icybr" monster attacks, it gains 500 ATK during damage calculation only, and if the attack target is in Defense Position, inflict piercing battle damage to your opponent.
	c:EnableReviveLimit()
