...
function s.initial_effect(c)
	--If another card(s) is returned from the field to the hand or Deck: You can Special Summon this card from your hand. If Summoned this way: Both players destroy the top 5 cards of their Decks.
