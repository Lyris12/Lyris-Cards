...
function s.initial_effect(c)
	--U-Each time a Monster Card(s) is destroyed, decrease this card's Energy by 1 for each destroyed card. ▲ [1]: (Quick Effect): Target 1 "Blitzkrieg" Monster Card you control; Take 1 "Blitzkrieg" monster in your Deck or face-up Extra Deck, and either place it in your Pendulum Zone or Special Summon it, then in either case, destroy that target.
	--M-If your opponent declares an attack that targets this card, destroy this card. After this card is Special Summoned, your "Blitzkrieg" cards cannot be destroyed by your opponent's card effects for the rest of that turn, except Monster Cards.
