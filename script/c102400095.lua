...
function s.initial_effect(c)
	--If this card attacks a Defense Position monster, inflict piercing battle damage. Gains 100 ATK for each "Swordsmaster" monster you control. A "Swordsmaster" Xyz Monster that has this card as material gains this effect. ● Neither player can activate monster effects in response to the activation of other "Swordsmaster" cards and effects, except Defense Position monsters'.
