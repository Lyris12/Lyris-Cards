...
function s.initial_effect(c)
	--2+ Level 4 "Entrafor" monsters Once per turn, during your Standby Phase: Attach the top card of your Deck to this card as material. Once per turn: You can detach 2 or more materials from this card, but not more than the number of monsters with Levels your opponent controls +1; attach as many of your opponent's monsters with Levels as possible to this card as material, but not more than the number of materials you detached to activate this effect -1.
	c:EnableReviveLimit()
