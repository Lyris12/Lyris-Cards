...
function s.initial_effect(c)
	--1 non-Tuner monster - 1 Dark Tuner You can target any number of Winged Beast monsters in your GY; Special Summon them, but their effects are negated, also they cannot be used as Fusion, Xyz, or Link Material for a Summon. You can only use this effect of "Raven of the Starless Night" once per turn.
	c:EnableReviveLimit()
