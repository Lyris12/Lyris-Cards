...
function s.initial_effect(c)
	--Activate 1 of these effects. ● Special Summon in Defense Position, 1 "Entraformer" monster attached to your Xyz Monster, then attach 1 "Entraformer" monster from your hand to that Xyz Monster. ● When a card or effect is activated that targets an "Entrafor" monster(s) you control: Negate the activation, then you can attach that card to 1 of your "Entraforemost" Xyz Monsters.
