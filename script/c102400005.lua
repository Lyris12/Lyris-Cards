...
function s.initial_effect(c)
	--Once while face-up on the field, when your "Inlightened" monster declares an attack: You can make the attack a direct attack instead. If your other monster attacked directly this turn, this card cannot attack. If your "Inlightened" monster attacks, after damage calculation: Target 1 card your opponent controls; destroy it, then if it was a monster and you attacked directly, inflict damage to your opponent equal to half its ATK on the field. You can only use this effect of "Inlightened Eatos Wings" once per turn.
