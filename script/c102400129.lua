...
function s.initial_effect(c)
	--2 "Blitzkrieg" monsters with different Attributes If your opponent declares an attack that targets this card: Negate the attack, also destroy this card and draw 1 card after that. If this card attacks or is attacked during the turn a card on the field is destroyed, your opponent takes no battle damage. If this card or a "Blitzkrieg" monster(s) this card points to is destroyed: For the rest of this turn, other "Blitzkrieg" monsters are unaffected by your opponent's card effects that do not target them.
	c:EnableReviveLimit()
