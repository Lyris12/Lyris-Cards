...
function s.initial_effect(c)
	--When this card is activated: You can add 1 "Swordsmaster" monster from your GY to your hand. If a "Swordsmaster" monster you control attacks an opponent's monster, that monster's effect is negated during the Battle Phase only. You can only control 1 "Swordsmaster Training".
