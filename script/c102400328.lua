...
function s.initial_effect(c)
	--You can Special Summon this card (from your hand) to your opponent's field in Attack Position, then shift control to this card's owner during the End Phase. If this card is Normal or Special Summoned: Its owner adds 1 "Rigil" card from their GY to their hand, also, if this card was Summoned using its own procedure, negate the first Summon you perform next turn, and if you do, destroy that monster(s). You can only use this effect of "Rigil Cintaurus" once per turn.
