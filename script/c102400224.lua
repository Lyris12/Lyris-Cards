...
function s.initial_effect(c)
	--Target 1 "YC.Org" monster in your GY; Special Summon it. You can banish this card from your GY, then target 1 "YC.Org" Spell/Trap in your GY; add it to your hand. You cannot Special Summon monsters the turn you activate this effect, except "YC.Org" monsters. You can only use this effect of "YC.Org Researcher - Archeology" once per turn.
