...
function s.initial_effect(c)
	--During the turn a Fusion Monster that lists "Elemental HERO Neos" as material was returned to the Extra Deck (Quick Effect): You can reveal this card in your hand; Special Summon this card, and it cannot be destroyed by battle or card effects, also you take no battle damage (these changes last until the end of the next turn).
