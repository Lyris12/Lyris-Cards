...
function s.initial_effect(c)
	--If there are 5 or more Set cards on the field, you can Special Summon this card (from your hand). If Summoned this way: Flip all monsters on the field face-up, also destroy all Set Spells/Traps on the field.
...
function s.activate(e,tp,eg,ep,ev,re,r,rp)
	...
	Duel.Destroy(Duel.GetMatchingGroup(s.filter,tp,LOCATION_ONFIELD,LOCATION_ONFIELD,nil),REASON_EFFECT)
end
