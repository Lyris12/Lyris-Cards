...
function s.initial_effect(c)
	--Equip only to a "Blitzkrieg" monster. Monsters your opponent controls cannot attack any monsters, except the equipped monster. If this card is destroyed: You can shuffle 3 face-up "Blitzkrieg" monsters from your Extra Deck into the Deck, and if you do, draw 1 card. You can only activate this effect of "Blitzkrieg Kalachakra" once per turn.
