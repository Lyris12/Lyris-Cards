...
function s.initial_effect(c)
	--Excavate 3 cards from the bottom of your Deck, and if you do, Special Summon 1 excavated "Hadouken" or "Shouryuken" monster, also place the other excavated cards on top of your Deck in any order. You can only use 1 "Hadouken Sacred Relics" per turn.
